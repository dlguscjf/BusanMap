...
//  BusanMap
//
//  Created by D7703_11 on 2018. 10. 30..
...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let center = CLLocationCoordinate2D(latitude: 35.180100, longitude: 129.081017)
        let span = MKCoordinateSpan(latitudeDelta: 0.27, longitudeDelta: 0.27)
        let region = MKCoordinateRegion(center: center, span: span)
        MyMapView.setRegion(region, animated: true)
        
        let a = BusanData(coordinate: CLLocationCoordinate2D(latitude:35.0999630, longitude: 35.0999630), title: "광복동", subtitle: "광복동주민센터")
        ...
        let f = BusanData(coordinate: CLLocationCoordinate2D(latitude: 35.1303210, longitude: 129.0876850), title: "대연동", subtitle: "부산공업초등학교")
        ...
        let o = BusanData(coordinate: CLLocationCoordinate2D(latitude: 35.1043270, longitude:  128.8556680), title: "녹산동", subtitle: "(주)삼성전기부산사업장 옥상")
